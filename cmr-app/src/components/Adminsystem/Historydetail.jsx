                ...
                <div className="justify-between sm:flex">
                    ...
                    <div className='sm:w-1/2'>
                        ...
                        <div className='mx-5 my-5'>
                            ...
                            <Divider />
                            <div className='mt-5 '>
                                <InputLabel  >ค่าปรับ</InputLabel>
                                <TextField InputProps={{ readOnly: true, }} id="fine" value={data?.fine} variant="standard" />
                            </div>
                            <div className='mt-5'>
                            <InputLabel  >หมายเหตุ</InputLabel>
                            <div className='mt-5 w-full'>
                                <TextField InputProps={{ readOnly: true, }} id="finedetail" defaultValue={data?.finedetail} className='w-full' multiline rows={8} />
