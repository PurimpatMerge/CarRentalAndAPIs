...
const App = () => {
  ...
  return (
    <BrowserRouter>
      ...
      <Route path="/Adminsystem" element={<ProtectedRoute allowedPositions={['Manager']}><Adminsystem /></ProtectedRoute>}>
      ...
      {/* Sale */}
      <Route path="/Adminsystem1" element={<ProtectedRoute allowedPositions={['Sale']}><Adminsystem1 /></ProtectedRoute>}>
